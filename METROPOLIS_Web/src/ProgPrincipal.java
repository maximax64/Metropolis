				  	...
				  	case 1:
				  		...
				  		//si le user  
				  		{
			  						...
			  						case 1:
			  							...
			  							switch(opt5)
			  							{
			  								case 1: 
			  									...
			  									leEmploye.inscriptionNouveauMembre(unMembre);
			  									System.out.println(unMembre.getLoginUser()+" "+unMembre.getPasswordUser());
			  		
			  									break;
			  								case 2:
			  									Employe unEmploye = new Employe();
			  									leEmploye.inscriptionNouveauEmploye(unEmploye);
			  									System.out.println(unEmploye.getLoginUser()+" "+unEmploye.getPasswordUser());
				  			...
				  			case "Membre": //est un membre
				  				...
				  				{
					  				case 1:
					  					System.out.print(leMembre.consulterParametres()+"\n");
					  					break;
					  				case 2:
